...
class Progress {
    ...
    apply(compiler) {
        ...
        function moduleDone() {
            ...
            id = relative(Root$1, id).replace(/^node_modules\//, '~/');
...
function BaseCompiler(props, config) {
  ...
  return {
    ...
    isProd ? new ChunkHash() : null, isProd ? new BundleAnalyzerPlugin({
      analyzerMode: 'static',
...
export { loadConfig, Frost, BaseCompiler, ClientCompiler, ServerCompiler, emitEvent, onEvent, Builder, Renderer };
